...
public class GapFillerTest {
    ...
    public void test1x2() throws Exception {
        assertArrayEquals(new double[]{3, 4},
                GapFiller.fillGaps(1, 2, new double[]{3, 4}),
                1e-8);
        assertArrayEquals(new double[]{3, 3},
                GapFiller.fillGaps(1, 2, new double[]{3, NaN}),
                1e-8);
        assertArrayEquals(new double[]{NaN, NaN},
                GapFiller.fillGaps(1, 2, new double[]{NaN, NaN}),
                1e-8);
    }
    ...
    public void test3x1() throws Exception {
        assertArrayEquals(new double[]{2, 3, 4},
                GapFiller.fillGaps(3, 1, new double[]{2, 3, 4}),
                1e-8);
        assertArrayEquals(new double[]{2, 3, 3},
                GapFiller.fillGaps(3, 1, new double[]{2, 3, NaN}),
                1e-8);
        assertArrayEquals(new double[]{3, 3, 3},
                GapFiller.fillGaps(3, 1, new double[]{NaN, 3, NaN}),
                1e-8);
        assertArrayEquals(new double[]{NaN, NaN, NaN},
                GapFiller.fillGaps(3, 1, new double[]{NaN, NaN, NaN}),
                1e-8);
    }
    ...
    public void test2x2() throws Exception {
        assertArrayEquals(new double[]{1, 2, 3, 4},
                GapFiller.fillGaps(2, 2, new double[]{1, 2, 3, 4}),
                1e-8);
        assertArrayEquals(new double[]{1, 2, 3, (1 + 2 + 3) / 3.0},
                GapFiller.fillGaps(2, 2, new double[]{1, 2, 3, NaN}),
                1e-8);
        assertArrayEquals(new double[]{1, (1 + 3) / 2.0, 3, (1 + 3) / 2.0},
                GapFiller.fillGaps(2, 2, new double[]{1, NaN, 3, NaN}),
                1e-8);

        assertArrayEquals(new double[]{3, 3, 3, 3},
                GapFiller.fillGaps(2, 2, new double[]{NaN, NaN, 3, NaN}),
                1e-8);

        assertArrayEquals(new double[]{NaN, NaN, NaN, NaN},
                GapFiller.fillGaps(2, 2, new double[]{NaN, NaN, NaN, NaN}),
                1e-8);
    }
    ...
    public void test4x4() throws Exception {
        assertArrayEquals(new double[]{
                ...
                GapFiller.fillGaps(2, 2, new double[]{
                        1, 2, 3, 4,
                        4, 3, 2, 1,
                        2, 3, 4, 5,
                        6, 5, 4, 3
        ...
        assertArrayEquals(new double[]{
                ...
                GapFiller.fillGaps(4, 4, new double[]{
                        1, 2, 3, 4,
                        4, F, 2, 1,
                        2, 3, 4, 5,
                        6, 5, 4, 3
