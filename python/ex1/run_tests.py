...
for i in range(20):
    ...
    t1 = timeit.timeit(setup=MAIN, number=times, stmt='pyimpl.com.bc.perfcomp.ex1(a, b)')
    t2 = timeit.timeit(setup=MAIN, number=times, stmt='cyimpl.com.bc.perfcomp.ex1(a, b)')
